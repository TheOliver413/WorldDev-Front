              ...
              <div className="col-sm-6">
                <div className="card">
                  ...
                  <div className="card-body">
                    ...
                    <p className="card-text">In this section you can modify a hotel by uploading its name, an image (drag the image or select one from a folder), choose the number of stars that corresponds, the exact address, location, state and a description of your services. </p>
