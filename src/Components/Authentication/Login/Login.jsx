...
export default function Login() {
  ...
  return (
    <form onSubmit={handleSubmit} className="mx-auto my-4 bg-white p-5 rounded-5 text-secondary shadow" style={{ maxWidth: "25rem" }}>
      ...
      <div className="d-flex justify-content-around mt-1">
        {/* <div className="d-flex align-items-center gap-1">
          ...
          <p className="login-text text-decoration-none fw-semibold fst-italic my-1" style={{ fontSize: "0.9rem" }} onClick={handleResetPassword}>
      ...
      <div className="d-flex gap-1 justify-content-center mt-1">
        ...
        <Link className="login-text text-decoration-none fw-semibold" to="/register">
          Register
        </Link>
      </div>
      ...
      <div className="mt-3">
        ...
        <Link className="login-text text-decoration-none fw-semibold" to="/terms">
          Terms and Conditions
        </Link> and&nbsp;
        <Link className="login-text text-decoration-none fw-semibold" to="/privacy">
          Privacy Policy
        </Link>
      </div>
    </form>
